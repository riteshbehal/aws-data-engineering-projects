...
try:
    ...
    raw_data_frame = glueContext.create_data_frame.from_options(
        ...
        connection_options={
            "streamARN": "arn:aws:kinesis:ap-south-1:463646775279:stream/mobile_coverage_logs",
            "classification": "json",
    ...
    s3_path = "s3://al-streaming-output/aggregations/"
    s3_path_checkpoint = "s3://al-streaming-output/checkpoints/"
